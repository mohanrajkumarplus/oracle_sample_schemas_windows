...
-- Create stored objects
   @D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\xdbSupport


-- Create directory object, instantiated by createUser.sql.sbs
 @D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\createUser &pass_oe &pass_sys &connect_string
...
-- Create folders and load
 @D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\xdb03usg
