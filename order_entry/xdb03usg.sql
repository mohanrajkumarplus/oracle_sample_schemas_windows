...
--
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\createFolders.sql


--
-- Load example documents into the XDB repository
--
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\createResources.sql
