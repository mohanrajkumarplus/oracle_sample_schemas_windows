...
CREATE OR REPLACE DIRECTORY data_file_dir AS 'D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\sales_history\'; 
CREATE OR REPLACE DIRECTORY log_file_dir  AS 'D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\log\'; 
CREATE OR REPLACE DIRECTORY media_dir     AS 'D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\product_media\';
