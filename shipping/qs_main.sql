...
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_adm

PROMPT calling qs_cre.sql ...
CONNECT qs/&pass@&connect_string;
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_cre

PROMPT calling qs_es.sql ...
CONNECT qs_es/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_es

PROMPT calling qs_ws.sql ...
CONNECT qs_ws/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_ws

PROMPT calling qs_os.sql ...
CONNECT qs_os/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_os

PROMPT calling qs_cbadm.sql ...
CONNECT qs_cbadm/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_cbadm

PROMPT calling qs_cs.sql ...
CONNECT qs_cs/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_cs

PROMPT calling qs_run.sql ...
CONNECT qs_adm/&pass@&connect_string
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\shipping\qs_run
