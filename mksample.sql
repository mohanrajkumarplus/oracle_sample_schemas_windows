...
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\human_resources\hr_main.sql &&password_hr &&default_ts &&temp_ts &&password_sys &&logfile_dir &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\oe_main.sql &&password_oe &&default_ts &&temp_ts &&password_hr &&password_sys D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\order_entry\ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string

SET SHOWMODE OFF

@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\product_media\pm_main.sql &&password_pm &&default_ts &&temp_ts &&password_oe &&password_sys D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\product_media\ &&logfile_dir D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\/product_media/ &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\info_exchange\ix_main.sql &&password_ix &&default_ts &&temp_ts &&password_sys &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\sales_history\sh_main.sql &&password_sh &&default_ts &&temp_ts &&password_sys D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\sales_history\ &&logfile_dir &vrs &&connect_string

CONNECT system/&&password_system@&&connect_string
SET SHOWMODE OFF

@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\bus_intelligence\bi_main.sql &&password_bi &&default_ts &&temp_ts &&password_sys &&password_oe &&password_sh &&logfile_dir &vrs &&connect_string
...
@D:\chrome_downloads\db-sample-schemas-21.1\db-sample-schemas-21.1\mkverify &&password_system &veri_spool &&connect_string
